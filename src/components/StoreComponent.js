...
//           </div>
//           <a href="#" className="text-blue-600 text-sm mt-1">View Store</a>
//         </div>
...
//                   selectedAvailable.includes(store.id) ? "bg-blue-200" : "hover:bg-gray-200"
//                 }`}
//                 onClick={() =>
...
//             onClick={() => dispatch(moveAllAvailableStoresToSelected())}
//           >
//             {`>>`}
//           </button>
//           <button
...
//           <button
//             className="px-4 py-2 bg-gray-300 rounded-md"
//             onClick={() => dispatch(moveAllSelectedStoresToAvailable())}
//           >
//             {`<<`}
//           </button>
//         </div>
...
//                 key={store.id}
//                 className={`p-2 cursor-pointer ${
//                   selectedSelected.includes(store.id) ? "bg-blue-200" : "hover:bg-gray-200"
//                 }`}
//                 onClick={() =>
